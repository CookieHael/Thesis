...
hold on
set(gca,'fontsize', 25);
scatter(linspace(2,13, 12),SNDRi, 100, 'filled','DisplayName', 'Noiseless ADC');
scatter(linspace(2,13, 12),SNDRideal, 100, 'filled','DisplayName', 'Ideal SNDR');
title("Ideal SNDR vs noisy ADC");
ylabel("SNDR (dB)");
